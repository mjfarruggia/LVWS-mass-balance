...
summary_df_nitrate <- summary_df_nitrate[order(summary_df_nitrate$AICc), ]
summary_df_nitrate$delta_AICc <- summary_df_nitrate$AICc - min(summary_df_nitrate$AICc)
...
save(mod.output, file="data/mj_aslo/LVWS_nitrate_output_05072026.Rdata")
